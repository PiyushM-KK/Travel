/*
 * Skyline Travel Planner — WhatsApp bot running on Claude (Anthropic)
 * ---------------------------------------------------------------------------
 ...
 *   2. Sends the message + Skyline rules to Claude (Anthropic).
 *   3. Sends Claude's reply back to the customer on WhatsApp.
 *
 * ── SETUP ──────────────────────────────────────────────────────────────────
 *   1. Install Node.js 18+.
 *   2. In this /server folder run:
 ...
 *   4. Start it:   node whatsapp-claude-bot.js
...
app.listen(PORT, () => console.log(`Skyline WhatsApp × Claude bot running on port ${PORT}`));
