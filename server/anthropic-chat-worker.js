...
export default {
  async fetch(request, env) {
    ...
    if (request.method === 'GET') {
      return new Response(
        JSON.stringify({ ok: true, version: 'anthropic-2', model: MODEL, hasKey: !!(env && env.ANTHROPIC_API_KEY) }),
